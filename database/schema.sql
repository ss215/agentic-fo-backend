-- Agentic F&O Execution System Database Schema
-- PostgreSQL Database Schema for Production Trading System
-- SEBI/NSE Compliant with Algo-ID Tagging and Audit Trails
...
-- CREATE USER agentic_app WITH PASSWORD 'agentic_password';

-- Grant permissions
-- GRANT CONNECT ON DATABASE agentic_fo TO agentic_app;
...
-- for the Agentic F&O Execution System

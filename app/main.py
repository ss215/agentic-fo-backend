...
from app.routes import auth, trading, monitoring, admin, breakdown_monitor, breakout_failure_monitor
...
app.include_router(breakout_failure_monitor.router, tags=["Breakout Failure"])
